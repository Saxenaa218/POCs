...
const Scheduler = (props) => {
  const { visible, setVisible, form, cronExpression, setCronExpression } = props;
      ...
      <>
        <Tabs defaultActiveKey="1" onChange={handleTabChange}>
          ...
          <TabPane tab="Day" key="4">
            <Day
              setDay={(dayOfMonth, dayOfWeek) => setExpression(dayOfMonth, 3, dayOfWeek, 5)}
            />
          </TabPane>
